...
3. For every finding, declare its comment scope before constructing the payload: point, method/design, or compact range. Record the proposed source anchor and a brief rationale for its semantic representativeness.
