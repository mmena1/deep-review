...
grep -q '^model = "gpt-6-luna"$' harnesses/codex/agents/deep-review-scout.toml || fail "Codex generic scout model drifted"
grep -q '^model_reasoning_effort = "high"$' harnesses/codex/agents/deep-review-scout.toml || fail "Codex generic scout reasoning effort drifted"
grep -q '^model = "gpt-6-sol"$' harnesses/codex/agents/deep-review-structural.toml || fail "Codex structural scout model drifted"
grep -q '^model_reasoning_effort = "high"$' harnesses/codex/agents/deep-review-structural.toml || fail "Codex structural scout reasoning effort drifted"
grep -q '^model = "gpt-6-sol"$' harnesses/codex/agents/deep-review-validator-static.toml || fail "Codex static validator model drifted"
...
grep -q '^model = "gpt-6-luna"$' harnesses/codex/agents/deep-review-validator-probe.toml || fail "Codex probe validator model drifted"
grep -q '^model_reasoning_effort = "high"$' harnesses/codex/agents/deep-review-validator-probe.toml || fail "Codex probe validator reasoning effort drifted"
